...
Import the database into you MySQL workbench(provided in the database folder) and just change the username and password according to you in connector.py file.
