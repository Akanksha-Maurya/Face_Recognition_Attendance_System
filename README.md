...
### Problems yet to be solved
 This is the 1st version of my application , so this is not giving very high accuracy in face recognition. For better face recognition, students have to neither too close to the camera nor very far from the camera.
